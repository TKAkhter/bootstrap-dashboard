<section class="container-fluid bg-color-scheme-2 py-3">
    ...
    <div class="row">
          ...
          <div class="d-flex justify-content-around">
            <div class="row gy-3">
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="box-round bg-color-scheme-2">
      ...
      <div id="brand-audience" class="col-lg-3 col-md-4 col-sm-12 main-columns">
        <div class="col box-round bg-white px-4 py-2 mb-3">
          ...
          <div class="row">
            <div class="col">
              <!-- <img src="<?php echo dirname($_SERVER['PHP_SELF']) . '..//assets/images/graph.png";' ?> class="mx-auto img-fluid" alt="Graph"> -->
        ...
        <div class="col box-round bg-white px-4 py-2 mb-3">
          ...
          <div>
            <img src="<?php echo dirname($_SERVER['PHP_SELF']) . '/assets/images/campaign.png'?>" class=" mx-auto img-fluid" alt="Graph">
          </div>
        </div>
      </div>
      <div id="brand-block" class="col-lg-4 col-md-12 col-sm-12 main-columns overflow-auto">
        <div class="col box-round bg-white px-4 py-2 mb-3">
          ...
          <div class="d-flex box-round bg-color-scheme-2 p-2 align-items-center mb-2">
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="">
                <img src="<?php echo dirname($_SERVER['PHP_SELF']) . '/assets/images/loreal-pakistan-logo-black.jpg'; ?>" class="mx-auto img-fluid rounded" alt="L'Oreal pakistan">
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 ps-3">
              <div id="border-right" class="border-end">
                <p>No. Of contact</p>
                <h4>1,000</h4>
              </div>
            </div>
